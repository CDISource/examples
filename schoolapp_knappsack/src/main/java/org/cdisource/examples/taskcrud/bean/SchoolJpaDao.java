package org.cdisource.examples.taskcrud.bean;
...
import org.cdisource.examples.taskcrud.event.StudentCoursePayload;
import org.cdisource.examples.taskcrud.model.BaseEntity;
import org.cdisource.examples.taskcrud.model.Course;
import org.cdisource.examples.taskcrud.model.Person;
import org.cdisource.examples.taskcrud.model.Student;
import org.cdisource.examples.taskcrud.model.Teacher;
import org.cdisource.examples.taskcrud.qualifier.DataRepository;
import org.cdisource.examples.taskcrud.qualifier.StudentAdded;
import org.cdisource.examples.taskcrud.qualifier.StudentRemoved;
...
public class SchoolJpaDao implements SchoolDao {
	...
	/* (non-Javadoc)
	 * @see org.cdisource.examples.taskcrud.bean.SchoolDao#searchStudents(org.cdisource.examples.taskcrud.bean.SearchCriteria, int, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
