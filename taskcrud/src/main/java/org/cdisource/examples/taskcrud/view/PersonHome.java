package org.cdisource.examples.taskcrud.view;
...
import org.cdisource.examples.taskcrud.bean.SchoolDao;
...
public class PersonHome extends EntityHome<Person> implements Serializable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.cdisource.examples.taskcrud.view.EntityHome#doInit()
	 */
	@Override
